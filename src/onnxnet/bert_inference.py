...
output_path = args.model_path / f"{args.prefix}pred"
if not output_path.exists():
    output_path.mkdir(parents=True)
output_pred = output_path / "predictions.csv"
output_json = output_path / "results.json"
...
dataloader = torch.utils.data.DataLoader(cast("torch.utils.data.Dataset[dict[str, Any]]", val_ds), batch_size=8)
